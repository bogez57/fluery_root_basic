...
pushd build
if "%samples_app_template%"=="1"       %compiler% %cl_flags% %gfx% %net%                               ..\code\samples\samples_app_template_main.c ..\code\render\d3d11\render_d3d11_main.cpp ..\code\font_provider\dwrite\font_provider_dwrite_main.cpp                        /link /out:samples_app_template.exe
if "%samples_datastructures%"=="1"     %compiler% %cl_flags% %console%                                 ..\code\samples\samples_datastructures_main.c                                                                                                                            /link /out:samples_datastructures.exe
