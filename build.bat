...
if "%g0%"=="1"                 cl %cl_flags% %telemetry% ..\code\g0\g0_main.c ..\code\render\d3d11\render_d3d11_main.cpp ..\code\font_provider\dwrite\font_provider_dwrite_main.cpp /link /out:g0.exe
