...
root_function FuzzyMatchList FindFuzzy8(Arena *arena, String8 haystack, String8 needle, U64 start_pos, MatchFlags flags);
...
root_function PathKind PathKindFromStr8(String8 path);
root_function String8List PathPartsFromStr8(Arena *arena, String8 path);
root_function String8List AbsolutePathPartsFromSourcePartsKind(Arena *arena, String8 source, String8List parts, PathKind kind);
root_function String8List DotResolvedPathPartsFromParts(Arena *arena, String8List parts);
root_function String8 NormalizedPathFromStr8(Arena *arena, String8 source, String8 path);
...
root_function TxtPt TxtPtFromStr8Off(String8 string, U64 off);
