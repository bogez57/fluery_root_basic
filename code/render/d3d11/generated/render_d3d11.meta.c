...
" \n"
" // rjf: shaded -> fogged\n"
" float4 fogged = float4(shaded.x + (fog_color.x-shaded.x)*fog_pct,\n"
"                        shaded.y + (fog_color.y-shaded.y)*fog_pct,\n"
"                        shaded.z + (fog_color.z-shaded.z)*fog_pct,\n"
"                        shaded.w + (fog_color.w-shaded.w)*fog_pct);\n"
" \n"
" // rjf: form color\n"
" float4 final_color = fogged;\n"
" //final_color = float4(shadow, shadow, shadow, shadow);\n"
" //final_color = float4(world_space_pos.x, world_space_pos.y, world_space_pos.z, 1);\n"
" //final_color = float4(shadowmap_clip_space_pos.x, shadowmap_clip_space_pos.y, shadowmap_clip_space_pos.z, 1);\n"
" return final_color;\n"
"}\n"
""
);
