...
"struct Vertex2Pixel\n"
"{\n"
" float4 position_clp       : SV_POSITION;\n"
" float2 rect_center_px     : POS;\n"
...
"//- rjf: helpers\n"
"\n"
"float RectSDF(float2 sample_pos, float2 rect_center, float2 rect_half_size, float r)\n"
"{\n"
...
" dst_p0_px = mul(xform, float3(dst_p0_px.x, dst_p0_px.y, 1)).xy;\n"
" dst_p1_px = mul(xform, float3(dst_p1_px.x, dst_p1_px.y, 1)).xy;\n"
...
" {\n"
"  vertex2pixel.position_clp.x       = 2 * dst_p_verts_px[cpu2vertex.vertex_id].x / viewport_size_px.x - 1.f;\n"
"  vertex2pixel.position_clp.y       = 2 * dst_p_verts_px[cpu2vertex.vertex_id].y / viewport_size_px.y - 1.f;\n"
"  vertex2pixel.position_clp.z       = 0.f;\n"
"  vertex2pixel.position_clp.w       = 1.f;\n"
"  vertex2pixel.rect_center_px       = (dst_p0_px+dst_p1_px)/2;\n"
"  vertex2pixel.rect_half_size_px    = dst_size_px/2 - float2(2*softness_px, 2*softness_px);\n"
...
"  vertex2pixel.colorcoord_pct       = dst_c_verts_pct[cpu2vertex.vertex_id];\n"
"  vertex2pixel.corner_radius_px     = dst_r_verts_px[cpu2vertex.vertex_id] * (2*vertex2pixel.rect_half_size_px.x) / dst_size_px.x;\n"
...
" float corner_radius_d_px = RectSDF(vertex2pixel.position_clp.xy, vertex2pixel.rect_center_px, vertex2pixel.rect_half_size_px, vertex2pixel.corner_radius_px);\n"
" float corner_radius_t = smoothstep(0, 2*vertex2pixel.softness_px, corner_radius_d_px);\n"
" \n"
" // rjf: apply border thickness\n"
" float border_thickness_d_px = RectSDF(vertex2pixel.position_clp.xy,\n"
"                                       vertex2pixel.rect_center_px,\n"
"                                       vertex2pixel.rect_half_size_px-vertex2pixel.border_thickness_px,\n"
"                                       max(vertex2pixel.corner_radius_px-vertex2pixel.border_thickness_px, 0));\n"
" float border_thickness_t = smoothstep(0, 2*vertex2pixel.softness_px, border_thickness_d_px);\n"
" if(vertex2pixel.border_thickness_px == 0)\n"
" {\n"
"  border_thickness_t = 1;\n"
" }\n"
" \n"
" // rjf: form+return final color\n"
" float4 final_color = albedo_sample;\n"
" final_color *= 1-corner_radius_t;\n"
" final_color *= border_thickness_t;\n"
" final_color *= tint;\n"
" final_color *= opacity;\n"
" return final_color;\n"
"}\n"
